...
const footerLinks: FooterLink[] = [
  ...
  { title: 'Twitter', url: links.twitter, external: true, icon: <Twitter fill={Color.primary} /> },
  { title: 'Terms', url: links.tos, external: true },
  { title: 'Discord', url: links.discord, external: true, icon: <Discord fill={Color.primary} /> },
  { title: 'Privacy', url: links.privacyPolicy, external: true },
  { title: 'Github', url: links.github, external: true, icon: <Github fill={Color.primary} /> },
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="ml-2 h-12 w-12 sm:h-14 sm:w-14">
        <HyperlaneLogo fill={Color.primary} />
      </div>
...
const styles = {
  linkGrid: 'grid grid-cols-2 gap-x-6 gap-y-1.5',
